...
public class People {
    ...
    public static void main(String[] args) {
        ...
        s.hakbun = "201350050"; // s가 붙으니까 이 변수들은 어디에 소속되있는지 알수있음
        s.name = "김태희";
        s.addr = "경기도고양시";
        s.birth = "1985.3.22";
        s.dname = "컴퓨터";
    ...
    static class Person {
        ...
        //  초기화 코드
        // }
        // 생성자의 매개변수명과 멤버변수명이 일치할면
        // 일반적으로 shadowing 현상이 발생
        // 클래스의 멤버변수임을 명확하게 표현하기 위해
        // this라는 키워드를 추가함
        public Person(String name, String job, int age, String gender,
                      String blood){
            this.name = name;
            this.job = job;
            this.age = age;
