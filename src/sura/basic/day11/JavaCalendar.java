...
public class JavaCalendar {
    public static void main(String[] args) {
        ...
        System.out.printf(fmt, d.getYear()+1900, d.getMonth()+1, d.getDate(), d.getHours(), d.getMinutes()
        ,d.getSeconds());

        Calendar c = Calendar.getInstance(); //싱글톤으로 작성하면 new쓸 필요 없음
        ...
        System.out.println(
                "오늘은 2021년중 " + c.get(Calendar.DAY_OF_YEAR)+ "일째 날입니다");
        ...
        SimpleDateFormat sdf = new SimpleDateFormat(fmt); // 매개변수로 형식을 지정해주어야함
