...
public class JavaString {
    public static void main(String[] args){
        ...
        // String 객체는 한번 생성되면 그 값을 읽기만 가능, 수정이 불가
        ...
        // 그 다음에 생성하는 String 객체의 값이 이전과 유사한 경우
        // String Pool에 만들어둔 객체를 재활용함
        String str1 = "Hello, World!!";
        // 힙 영역 내 상수풀에 생성

        String str2 = new String("Hello, World!!");
        // 힙 영역에 생성
        // str2는 새로운 메모리에 저장되었기 때문에
        // str1과 str2는 저장위치가 다르므로 같지 않다
        ...
        // ex) Hello, java!!라는 문자열에서 각 단어의 첫글자만 골라서
        ...
        System.out.println(String.valueOf(height)); // 이 방법 추천!
        ...
        System.out.println(sb.toString()); //StringBuilder로 변환한 건 반환할때 toString()으로 문자열로 바꿔줘야함
