...
public class EX02 {
	public static void main(String[] args) {
		...
		// 큰따옴표로 묶여있는 문자열은 수식에 사용불가,
		// 단일문자는 수식에 사용하면 자동으로 숫자형으로 변환이 되서 가능
		// 숫자형으로 변환시 ASCII코드값을 기준
		// 숫자 0은 십진수로 48, A : 65, a : 97 ( 이것들은 알아놓기 !)
		// => Z : 90, D : 68, M : 77
		...
		// H와 I사이에 산술 연산이 들어가기때문에
		// H와 I가 숫자형으로 바뀌어서 + 연산이 수행됨
